...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        <title>Wende Luvinga - <?php echo $__env->yieldContent('title'); ?></title>
        <meta charset="utf-8">
    ...
    <body>
        <section class="header uk-container">
            <div class="uk-navbar-left">
                <a class="uk-navbar-item uk-logo" href="#"><img src="<?php echo e(URL::asset('img/logo.png')); ?>" alt="Logo"></a>
            </div>
                ...
                <div class="footer uk-padding">
                    <div uk-grid class="uk-child-width-expand@s">
                        <div class="footer-logo">
                            <a href="#"><img src="<?php echo e(URL::asset('img/logo-white.png')); ?>" alt="Logo white"></a>
                        </div>
...
</html><?php /**PATH /Users/Paul/Desktop/Dev/PHP/wendeluvinga.com/resources/views/layout/layout.blade.php ENDPATH**/ ?>